...
ms.openlocfilehash: 0d2c91f0f42e4b8eafecd91fcb444dba8f4e8508
ms.sourcegitcommit: db124fa9-b335-4fd7-8db1-f6c4a0a220f4
ms.translationtype: HT
ms.contentlocale: en-US
ms.lasthandoff: 06/20/2019
---
# <a name="turn-external-sharing-on-or-off-for-a-site"></a>Turn external sharing on or off for a site

アドミンでないとねYou must be a global or SharePoint admin in Office 365 to change the external sharing setting for a site (previously called a "site collection"). Site owners are not allowed to change this setting.
...
### <a name="which-option-to-select"></a>Which option to select...
